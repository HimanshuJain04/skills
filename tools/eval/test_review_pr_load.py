...
CORPUS_CEILING = 187398
CEILINGS = {
    "parallel-standard/round-1": (130049, 130049, 15),
    "parallel-chunked/round-1": (131584, 131584, 15),
    "parallel-standard/with-step6-reload": (130049, 138379, 15),
}
