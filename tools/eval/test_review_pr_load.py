...
CORPUS_CEILING = 186929
CEILINGS = {
    "parallel-standard/round-1": (129794, 129794, 15),
    "parallel-chunked/round-1": (131329, 131329, 15),
    "parallel-standard/with-step6-reload": (129794, 138124, 15),
}
