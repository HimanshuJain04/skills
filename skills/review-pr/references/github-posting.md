...
## Step 9: Emit the review URL

After Step 8 reconciles, build the clickable review URL from the reconciled database ID and print it as the `**Review URL**` line in the Phase 4 header block:
